...
drop table if exists title cascade constraints;
drop table if exists title_copy cascade constraints;
drop table if exists rental cascade constraints;
drop table if exists reservation cascade constraints;
drop view if exists title_avail;
